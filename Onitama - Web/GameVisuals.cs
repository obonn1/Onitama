...
public class GameVisuals : DrawTools
{
    ...
    public void DrawState(Graphics g)
    {
        ...
        NeutralCard!.DrawGrid(g, new PointF(3.025f, 0.175f), 1.25f);
        Card.Invert(NeutralCard).DrawGrid(g, new PointF(5.625f, 0.175f), 1.25f);
    ...
    private static void DrawCard(Graphics g, Card card, RectangleF location, bool isActive, Team team)
    {
        ...
        card.DrawGrid(g, new(location.X + 0.05f, location.Y + 0.05f), 1.6f);
    }
